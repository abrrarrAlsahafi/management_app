...
class _MeetingsScreenState extends State<MeetingsScreen> {
          ...
          // print("stage.. ${st} $isAction");
            ...
            Container(
                    ...
                    child: Dismissible(
                      ...
                      background:isMember?SlideRightBackgroundWidget():Container(),
                      secondaryBackground: action?//isAction[index]?
                      SlideLeftWidget(
                              icon: Icons.redo,
                      ...
                      child: CartTask(
                        ...
                        listTile: ListTile(
                            ...
                            subtitle: Text(
                                "No. ${meetings[index].id} is ${meetings[index].stage}  on ${DateFormat.yMd().add_jm().format(DateTime.now())}",
                                style: TextStyle(fontSize: 10))),
                      ),
                    ),
                  );
 ...
 Future<String> showAlertDialog(BuildContext context, widgetTitle, id, stage) async {
...
str=stage;
    ...
    else if(stage=="members"&&(userType=='member'||userType=='editor'||userType=='manager'||userType=='approval')&&
...
*/
    ...
    Provider
        .of<BoardsModel>(context, listen: false)
        .userBoard
        .forEach((element) {
      if (element.id == widget.id) {

        if (element.editor == Provider
            .of<UserModel>(context, listen: false)
            .user
            .name) {
          currentType= "editor";
        }
        else if (element.manager == Provider
            .of<UserModel>(context, listen: false)
            .user
            .name) {
        ...
        else if (element.approval == Provider
            .of<UserModel>(context, listen: false)
            .user
            .name) {
          return "approval";
